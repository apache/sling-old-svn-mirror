...
public class ComponentResponseWrapper extends HttpServletResponseWrapper implements ComponentResponse {
    ...
    public ComponentResponse getComponentResponse() {
        return (ComponentResponse) this.getResponse();
    }
    ...
    public String getContentType() {
        return this.getComponentResponse().getContentType();
    }
    ...
    public String getNamespace() {
        return this.getComponentResponse().getNamespace();
    }

    public void setCharacterEncoding(String charset) {
        this.getComponentResponse().setCharacterEncoding(charset);
    }
}
