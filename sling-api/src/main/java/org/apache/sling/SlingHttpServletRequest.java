...
public interface SlingHttpServletRequest extends HttpServletRequest {
    ...
    /**
     * Returns the {@link ProcessTracker} of this request.
     */
    ProcessTracker getProcessTracker();

    /**
     * Returns a {@link ServiceLocator} instance which may be queried for helper
     * services such as the {@link org.apache.sling.resource.ResourceResolver},
     * {@link org.apache.sling.scripting.SlingScriptResolver} and
     * {@link org.apache.sling.servlets.ServletResolver}.
     */
