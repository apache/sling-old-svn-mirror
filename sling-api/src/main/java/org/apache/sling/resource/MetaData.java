...
/**
 * The <code>MetaData</code> interface defines the API for the metadata of a
 * Sling {@link Resource}. Essentially the resource's metadata is just a map of
 * objects indexed by string keys.
 * <p>
