 ...
 *      <li>{@code ClientSideTeleporter.testReadyTimeoutSeconds},how long to wait for our test to be ready on the server-side, after installing the test bundle. By default {@code 12}.</li>
