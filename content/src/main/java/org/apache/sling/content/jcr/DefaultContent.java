...
/**
 * The <code>DefaultContent</code> class is a default <code>Content</code>
...
public class DefaultContent extends HashMap implements Content {
    ...
    /**
     * The name of the property providing the component ID (value is
     * "sling:componentId"). This property is assumed to be a single-valued
     * property of type <i>STRING</i> /valk
     */
    public static final String COMPONENT_ID_PROPERTY = "sling:componentId";
    ...
    /**
     * Returns the value of the {@link #COMPONENT_ID_PROPERTY} property as a
     * string or the primary node type of the underlying node if component id
     * property exists.
     */
