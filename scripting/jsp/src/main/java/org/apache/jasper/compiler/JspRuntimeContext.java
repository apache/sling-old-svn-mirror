...
public final class JspRuntimeContext implements Runnable {
    ...
    /** The {@link OutputProvider} used to get access to output */
    private OutputProvider outputProvider = OutputProvider.DEFAULT;
    ...
    /**
     * Returns the current {@link OutputProvider} of this context.
     */
    ...
    /**
     * Sets the {@link OutputProvider} to use in this context.
     * 
     * @param outputProvider The {@link OutputProvider} to use in this context.
     *      If this is <code>null</code> the {@link OutputProvider#DEFAULT default}
     *      provider is set.
     */
    public void setOutputProvider(OutputProvider outputProvider) {
        this.outputProvider = (outputProvider == null)
                ? OutputProvider.DEFAULT
                : outputProvider;
    }
