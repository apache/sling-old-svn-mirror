...
public class PostServletOrderTest extends MicroslingHttpTestBase {
   ...
   public void testPostPathIsUnique() throws IOException {
    ...
    public void testStandardOrder() throws IOException {
        ...
        nodeUrl[0] = testClient.createNode(postUrl + "/*", null);
        nodeUrl[1] = testClient.createNode(postUrl + "/*", null);
        nodeUrl[2] = testClient.createNode(postUrl + "/*", null);
        nodeUrl[3] = testClient.createNode(postUrl + "/*", null);
    ...
    public void testZeroOrder() throws IOException {
        ...
        nodeUrl[1] = testClient.createNode(postUrl + "/*", props);
        nodeUrl[2] = testClient.createNode(postUrl + "/*", props);
        nodeUrl[3] = testClient.createNode(postUrl + "/*", props);
