 ...
 */
package org.apache.sling.slingbucks2.server;
 ...
 *
 *  NOTE: In the OSGi Annotations for a Property any type
 *        except Strings must be set after then name separated
 *        with a colon. The type is the same as the Java's
 *        Class of the corresponding element type (boolean -> Boolean)
 */
@Component(
    service = Runnable.class,
    property = {
        Constants.SERVICE_DESCRIPTION + "=Slingbucks Confirmed Order Observer (HTL)",
        Constants.SERVICE_VENDOR + "=The Apache Software Foundation",
        "scheduler.period:Long=1",
