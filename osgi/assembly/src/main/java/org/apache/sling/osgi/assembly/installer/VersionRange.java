...
public class VersionRange {
     ...
     *      version range or not.
     * @param high The upper limit of the version range. If <code>null</code>
     *      the new version range has no upper limit.
     * @param isHighInclusive Whether the high version is included in the
     *      version range or not. If <code>high</code> is <code>null</code>,
