...
public interface Resource {
     ...
     * {@link MetaData} object returned is implementation specific except for
     * the {@link MetaData#RESOLUTION_PATH} property which is required to be set
     * to the part of the request URI used to resolve the resource.
     *
     * @see MetaData
     */
