...
public class SlingVersionResolver implements VersionResolver {
    ...
    public SlingVersionResolver() {
        ...
        versions.put("org.apache.jackrabbit:jackrabbit-data", "2.12.2");
        versions.put("org.apache.jackrabbit:jackrabbit-jcr-commons", "2.12.2");
        versions.put("org.apache.jackrabbit:jackrabbit-jcr-rmi", "2.12.2");
        versions.put("org.apache.jackrabbit:jackrabbit-spi", "2.12.2");
        versions.put("org.apache.jackrabbit:jackrabbit-spi-commons", "2.12.2");
        versions.put("org.apache.jackrabbit:jackrabbit-webdav", "2.12.2");
        versions.put("org.apache.jackrabbit:oak-blob", "1.5.5");
        versions.put("org.apache.jackrabbit:oak-commons", "1.5.5");
        versions.put("org.apache.jackrabbit:oak-core", "1.5.5");
        versions.put("org.apache.jackrabbit:oak-jcr", "1.5.5");
        versions.put("org.apache.jackrabbit:oak-lucene", "1.5.5");
        versions.put("org.apache.jackrabbit:oak-segment", "1.5.5");
