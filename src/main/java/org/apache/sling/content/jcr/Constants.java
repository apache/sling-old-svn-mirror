...
/**
 * The <code>Constants</code> interface provides constant values for event
 * topics and event properties for events sent from this bundle.
 */
public interface Constants {
     ...
     * mapped (value is "http://incubator.apache.org/graffito").
     */
    static final String GRAFFITO_NS_URI = "http://incubator.apache.org/graffito";

    /**
     * The namespace prefix used for the
     * {@link #GRAFFITO_NS_URI mapping namespace URI} (value is "graffito").
     */
    static final String GRAFFITO_NS_PREFIX = "graffito";
