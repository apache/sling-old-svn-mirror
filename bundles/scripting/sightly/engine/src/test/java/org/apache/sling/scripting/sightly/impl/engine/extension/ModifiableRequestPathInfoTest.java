...
public class ModifiableRequestPathInfoTest {
    ...
    private static final URIManipulationFilterExtension.ModifiableRequestPathInfo emptyPathInfo = new URIManipulationFilterExtension.ModifiableRequestPathInfo(EMPTY);
    private static final URIManipulationFilterExtension.ModifiableRequestPathInfo simplePath = new URIManipulationFilterExtension.ModifiableRequestPathInfo(PATH);
    ...
    private static final URIManipulationFilterExtension.ModifiableRequestPathInfo
            pathWithSelectors = new URIManipulationFilterExtension.ModifiableRequestPathInfo(PATH + "." + SELECTOR_STRING + "." + EXTENSION);
    private static final URIManipulationFilterExtension.ModifiableRequestPathInfo
            pathWithSelectorsSuffix = new URIManipulationFilterExtension.ModifiableRequestPathInfo(PATH + "." + SELECTOR_STRING + "." + EXTENSION + SUFFIX);
    private static final URIManipulationFilterExtension.ModifiableRequestPathInfo
            pathWithMultipleDotsSuffix = new URIManipulationFilterExtension.ModifiableRequestPathInfo("test/child.name/resource." + SELECTOR_STRING + "." + EXTENSION + SUFFIX);
