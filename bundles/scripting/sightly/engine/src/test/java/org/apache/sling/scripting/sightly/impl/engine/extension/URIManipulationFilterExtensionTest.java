...
public class URIManipulationFilterExtensionTest {
    ...
    public void testUnescapePercentInQuery() throws URISyntaxException {
        ...
        assertEquals("http://example.com/example/search.html?q=6%25-10%25#fragment=%25", URIManipulationFilterExtension.unescapePercentInQuery(testUri.toString()));
        testUri = new URI("http", null, "example.com", -1, "/example/search.html", "q=6%25-10%25", null);
        assertEquals("http://example.com/example/search.html?q=6%25-10%25", URIManipulationFilterExtension.unescapePercentInQuery(testUri.toString()));
    }
