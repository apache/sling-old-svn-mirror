...
public class Import implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource(iauName + " = " +
                "org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + urlName + ");");
        ...
        if(hasVarReader){
            ...
            ctxt.generateJavaSource("            " + charSetName + " = " +
                    "org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.getContentTypeAttribute(" + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) " 
                    + charSetName + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
