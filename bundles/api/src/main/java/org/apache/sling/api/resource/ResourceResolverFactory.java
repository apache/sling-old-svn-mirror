...
public interface ResourceResolverFactory {
     ...
     *             data.
     */
    ResourceResolver getResourceResolver(@CheckForNull Map<String, Object> authenticationInfo) throws LoginException;
     ...
     */
    @Deprecated
    ResourceResolver getAdministrativeResourceResolver(@CheckForNull Map<String, Object> authenticationInfo) throws LoginException;
     ...
     *      Authentication</a>
     */
    ResourceResolver getServiceResourceResolver(@CheckForNull Map<String, Object> authenticationInfo) throws LoginException;
