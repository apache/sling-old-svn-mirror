...
import org.apache.sling.jcr.resource.internal.mapping.PersistenceManagerProviderImpl;
 ...
 * @author fmeschbe
 */
public class JcrContentHelper implements JcrResourceManagerFactory,
     ...
     */
    public ResourceManager getResourceManager(Session session) throws SlingException{
        return this.pmProvider.getResourceManager(session);
    }
